#' Create a Blank Quarto File - Coding Lesson
#'
...
#'
#' @param template_name The name of the Quarto skeleton file = "lesson_coding". You
...
#'
#' # With defaults
#' # new_quarto_lesson_coding()
#'
#' # Set a new file name
#' # new_quarto_lesson_coding("test_qmd_file")
#'
