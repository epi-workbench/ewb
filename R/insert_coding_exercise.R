#' Insert an Complete Coding Exercise Workflow into a Quarto Lesson
#'
#' @description
#' Launches an RStudio Addin that interactively inserts an exercise code block,
#' a solution code block, a hidden code block, a test code block, and a hint
#' block template into the active Quarto lesson at the current cursor location.
#'
...
#'   using `library()`.
#'
#' The inserted hidden code block includes simulated submissions. The inserted
#' test code block includes CST scaffolding and a reminder to structure tests
...
insert_coding_exercise <- function() {
  ...
  ui <- miniUI::miniPage(
    miniUI::gadgetTitleBar("Insert Coding Exercise"),
  ...
  server <- function(input, output, session) {
    ...
    shiny::observeEvent(input$done, {
      ...
      hint_text <- switch(
        ...
        "default" = coding_exercise_default(),
        "no_mod" = coding_exercise_no_mod(),
        "load_package" = coding_exercise_load_package()
      )
...
# Default Template
# ---------------------------------------------------------------------------
coding_exercise_default <- function() {
  paste(
    exercise_code_block,
    solution_code_block,
    hidden_cb_begin,
...
# ---------------------------------------------------------------------------
coding_exercise_no_mod <- function() {
  paste(
    exercise_code_block,
    solution_code_block,
    hidden_cb_begin,
...
# ---------------------------------------------------------------------------
coding_exercise_load_package <- function() {
  paste(
    exercise_code_block,
    solution_code_block,
    hidden_cb_begin,
