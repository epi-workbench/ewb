# =============================================================================
# Unit tests for the new_quarto_course_overview() function.
#
...
test_that("The new_quarto_course_overview() function creates the expected Quarto file", {
  ...
  new_quarto_course_overview(file_name = file_nm, file_loc = temp_dir)
  new_temp_file_path <- paste0(temp_dir, "/", file_nm, ".qmd")
  expect_snapshot_file(new_temp_file_path, "test-new_quarto_course_overview.qmd")
})
